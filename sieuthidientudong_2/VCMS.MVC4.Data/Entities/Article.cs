        ...
        {  
            ...
            {    
                using (DataContext db = new DataContext())
                {
                    ...
                    //if (language.Code.Equals("vi", StringComparison.OrdinalIgnoreCase))
                    //    return date.ToString("dd MMM , yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"));
                    //return date.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"));
        ...
        public string Daymore
        {
            get
            {
                using (DataContext db = new DataContext())
                {
                    ...
                    //var language = db.Languages.FirstOrDefault(a => a.Id == this.LanguageId);
                    //if (language.Code.Equals("vi", StringComparison.OrdinalIgnoreCase))
                    //    return date.ToString("dd MMM , yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"));
                }
            }
            ...
            get
            {
                if (this.ArticleDetail.Count > 0 && this.LanguageId >= 1)
                {
                    if (!string.IsNullOrEmpty(this.ArticleDetail[this.LanguageId].UrlFriendly))
                        return this.ArticleDetail[this.LanguageId].UrlFriendly.ToString().ToLower();
